...
def test_new_product_create_new():
    """
    Проверяет создание нового продукта методом new_product,
    если товара с таким именем нет в списке.
    """
    data = {
        "name": "Laptop",
...
def test_new_product_update_existing():
    """
    Проверяет обновление существующего продукта:
    - увеличение количества
    - обновление цены до максимальной
    """
    existing = Product("Laptop", "Old", 1500, 2)
